                                ...
                                resize: function (e) {
                                    ...
                                    if (i.width !== s || i.height !== d) {
                                        ...
                                        t.plugins.notify('resize', [a, u]),
                                            ...
                                            e || (a.stop(), a.update(a.options.responsiveAnimationDuration));
                                    }
                                },
                                ...
                                eventHandler: function (t) {
                                    ...
                                    return (
                                        r
                                            ...
                                            : o && !e.animating && (e.stop(), e.render(n.animationDuration, !0)),
                                        (e._bufferedRender = !1),
                            ...
                            i.extend(t.DatasetController.prototype, {
                                ...
                                buildOrUpdateElements: function () {
                                    var t = this,
                                        i = t.getDataset(),
                                        n = i.data || (i.data = []);
                                    t._data !== n && (t._data && a(t._data, t), e(n, t), (t._data = n)),
                                        t.resyncElements();
                                },
                                update: i.noop,
                                draw: function (t) {
                            ...
                            update: function (t, a, i) {
                                function n(t) {
                                    var e,
                                        a = t.isHorizontal();
                                    a
                                        ? ((e = t.update(t.options.fullWidth ? x : C, M)), (D -= e.height))
                                ...
                                if (t) {
                                    var s = t.options.layout,
                                        ...
                                        f = 0;
                                    isNaN(d)
                                        ? ((u = d.left || 0), (c = d.right || 0), (h = d.top || 0), (f = d.bottom || 0))
                                        : ((u = d), (c = d), (h = d), (f = d));
                                    ...
                                    if (
                                        ...
                                        if (((l.font = f), m)) {
                                            ...
                                            a.each(i.legendItems, function (t, a) {
                                                ...
                                                w + M > p.height && ((k += S + o.padding), y.push(S), (S = 0), (w = 0)),
                                                    (S = Math.max(S, n)),
                                                    (w += M),
                                ...
                                draw: function () {
                                    ...
                                    if (n.display) {
                                        ...
                                        var v = e(o, g),
                                            ...
                                            S = i.isHorizontal();
                                        u = S
                                            ? { x: i.left + (s - d[0]) / 2, y: i.top + o.padding, line: 0 }
                                        ...
                                        a.each(i.legendItems, function (t, e) {
                                            ...
                                            S
                                                ? r + n >= s &&
                                                  ((l = u.y += w), u.line++, (r = u.x = i.left + (s - d[u.line]) / 2))
                                                : l + w > i.bottom &&
                                ...
                                logarithmic: function (t, a) {
                                    for (
                                        ...
                                        0 === o
                                            ...
                                            : ((r = Math.floor(e.log10(o))), (l = Math.floor(o / Math.pow(10, r)) + 1)),
                                            10 === l && ((l = 1), ++r),
                                            (o = l * Math.pow(10, r));
                                    }
                                    var s = n(t.max, o);
                        ...
                        function r(t, e) {
                            ...
                            'center' === r
                                ...
                                l(a.x)
                                    ...
                                    : s(a.x) && ((o = 'right'), u(a.x) && ((o = 'center'), (r = c(a.y))));
                            var g = t._options;
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                handleEvent: function (t) {
                                    ...
                                    if (
                                        ...
                                        'mouseout' === t.type
                                            ? (e._active = [])
                                            : (e._active = e._chartInstance.getElementsAtEventForMode(t, a.mode, a)),
