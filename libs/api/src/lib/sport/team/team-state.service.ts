...
export abstract class TeamStateService extends EntityStateService {
    ...
    public abstract dispatchListMatchTeamsByMatchIdAction(matchId: string): void;
    ...
    public abstract dispatchUpdateMatchTeamByMatchIdAction(matchTeam: Partial<EventTeam>, matchId: string): void;
    ...
    public abstract selectMatchTeamByMatchId$(matchId: string): Observable<EventTeam[]>;
