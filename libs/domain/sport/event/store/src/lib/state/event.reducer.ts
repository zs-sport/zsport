...
export const eventReducer = createReducer(
    ...
    on(eventActions.ListEventesByCompetitionIdSuccess, (state, { eventes }) => eventAdapter.upsertMany(eventes, state)),
    on(eventActions.listEventsByDaySuccess, (state, { eventes }) => eventAdapter.upsertMany(eventes, state)),
