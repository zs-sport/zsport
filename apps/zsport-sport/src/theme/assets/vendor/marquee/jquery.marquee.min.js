            ...
            if ('string' === typeof x)
                ...
                if (v) {
                    ...
                    a.startVisible && !a.duplicated
                        ? ((a._completeDuration = ((parseInt(q, 10) + parseInt(k, 10)) / parseInt(k, 10)) * a.duration),
                          (a.duration *= parseInt(q, 10) / parseInt(k, 10)))
                        : (a.duration *= (parseInt(q, 10) + parseInt(k, 10)) / parseInt(k, 10));
                } else {
                    var m = b.find('.js-marquee:first').width() + a.gap;
                    var n = b.width();
                    a.startVisible && !a.duplicated
                        ? ((a._completeDuration = ((parseInt(m, 10) + parseInt(n, 10)) / parseInt(n, 10)) * a.duration),
                          (a.duration *= parseInt(m, 10) / parseInt(n, 10)))
                        : (a.duration *= (parseInt(m, 10) + parseInt(n, 10)) / parseInt(n, 10));
                }
                    ...
                    ? (v
                          ? a.startVisible
                              ...
                              : c.css(
                                    'transform',
                                    'translateY(' +
                                        ('up' == a.direction ? k + 'px' : '-' + (2 * q - a.gap) + 'px') +
                                        ')'
                                )
                          : a.startVisible
                          ...
                          : c.css(
                                'transform',
                                'translateX(' + ('left' == a.direction ? n + 'px' : '-' + (2 * m - a.gap) + 'px') + ')'
                            ),
                      a.startVisible || (e = 1))
                    : a.startVisible
                    ? (e = 2)
                ...
                var w = function () {
                    ...
                    v
                        ? a.duplicated
                            ? (2 < e &&
                                  c.css('transform', 'translateY(' + ('up' == a.direction ? 0 : '-' + q + 'px') + ')'),
                              (t = { transform: 'translateY(' + ('up' == a.direction ? '-' + q + 'px' : 0) + ')' }))
                            : a.startVisible
                            ? 2 === e
                                ? (d &&
                                      (d =
                                  ...
                                  (t = {
                                      transform:
                                          'translateY(' + ('up' == a.direction ? '-' + q + 'px' : k + 'px') + ')',
                                  }),
                                  e++)
                                : 3 === e &&
                            ...
                            : (C(),
                              (t = {
                                  transform:
                                      'translateY(' + ('up' == a.direction ? '-' + c.height() + 'px' : k + 'px') + ')',
                              }))
                        : a.duplicated
                        ? (2 < e &&
                              c.css('transform', 'translateX(' + ('left' == a.direction ? 0 : '-' + m + 'px') + ')'),
                          (t = { transform: 'translateX(' + ('left' == a.direction ? '-' + m + 'px' : 0) + ')' }))
                        : a.startVisible
                        ? 2 === e
                            ? (d &&
                                  (d =
