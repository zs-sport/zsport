...
!(function (n, t, e) {
    ...
    function P(n, t) {
        return R(n)
            ? new k.LatLngBounds({ lat: n[2], lng: n[3] }, { lat: n[0], lng: n[1] })
            : t && !n.getCenter
            ? new k.LatLngBounds({ lat: n.south, lng: n.west }, { lat: n.north, lng: n.east })
            : n;
    }
    function b(t, o) {
        function r() {
            ...
            (M.directionsrenderer = g(function (t) {
                ...
                return (
                    t &&
                        ((t = o(t)),
                        (t.map = v),
                        t.panel && (t.panel = n(t.panel).get(0)),
                        (e = l('DirectionsRenderer', t))),
                    y.push(e),
                    e
                );
            })),
