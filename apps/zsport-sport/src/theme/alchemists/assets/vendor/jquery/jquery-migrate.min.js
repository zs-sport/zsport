...
void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0),
    (function (e) {
        ...
        (e.fn.init = function (e) {
            ...
            return (
                'string' == typeof e && '#' === e && (r("jQuery( '#' ) is not a valid selector"), (t[0] = [])),
                i.apply(this, t)
            );
        }),
                    ...
                    : (r('jQuery.fn.toggleClass( boolean ) is deprecated'),
                      this.each(function () {
                          ...
                          r && e.data(this, '__className__', r),
                              this.setAttribute &&
                                  this.setAttribute('class', r || !1 === t ? '' : e.data(this, '__className__') || '');
                      }));
            });
        var h = !1;
        e.swap &&
        ...
        e.param = function (t, n) {
            ...
            return (
                void 0 === n && a && (r('jQuery.param() no longer uses jQuery.ajaxSettings.traditional'), (n = a)),
                k.call(this, t, n)
            );
        };
        ...
        e.fn.andSelf = function () {
            return (
                r('jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()'), A.apply(this, arguments)
            );
        };
        var S = e.Deferred,
            q = [
